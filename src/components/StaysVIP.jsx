  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.topbar}><div style={{ ...s.wrap, display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
        ...
        <div style={{ fontSize: 11, color: C.dim, border: `1px solid ${C.line}`, padding: '5px 12px', borderRadius: 20 }}>VIP Concierge · Powered by 4TC Concierge Hospitality Group</div>
      </div></div>
      ...
      <div style={{ ...s.wrap, display: 'grid', gridTemplateColumns: 'minmax(0,1fr) 372px', gap: 32, padding: '26px 0 90px', alignItems: 'start' }} className="ps-b2b-grid">
        <div>
          ...
          <AddonSection num="2" title="Sound & entertainment" sub="Pro DJ + sound gear delivered to your estate for private sets & content · Rock N Roll Rentals" cat="gear" qty={qty} chg={chg} stepper={stepper} C={C} />
          ...
          <AddonSection num="5" title="Chauffeured transport" sub="Private Sprinter & black-car service — estate, venue & airport · Fetii (per vehicle)" cat="van" qty={qty} chg={chg} stepper={stepper} C={C} />
        </div>
