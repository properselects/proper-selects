...
const PROPS = [
  ...
  { id: 'p4', mgr: 'five', name: 'Serenita Estate', badge: 'Hill Country', price: 599, br: '7 BR · 5 BA · sleeps 30', hood: 'Austin',
  ...
  { id: 'p5', mgr: 'five', name: 'La Mariposa', badge: 'Biggest group', price: 699, br: '10 BR · 6 BA · sleeps 25', hood: 'Austin',
    img: 'https://uc.orez.io/i/a110e28a0f32492c89869f40d84faa38-Medium',
    url: 'https://www.fivestarvacationhomerentals.com/la-mariposa-2-luxury-homes-on-full-acre-sleeps-25-orp5b6addcx', amen: '2 luxury homes · full acre · pool & spa' },
  { id: 'p6', mgr: 'five', name: 'Estrella Azul', badge: 'Central Austin', price: 487, br: '4 BR · 3 BA · sleeps 12', hood: 'South Lamar',
    img: 'https://uc.orez.io/i/02207f1c3726418798aae00f0e39b1b0-Medium',
    url: 'https://www.fivestarvacationhomerentals.com/estrella-azul-a-luxury-escape-in-the-heart-of-austin-orp5b6d7c1x', amen: '35ft heated pool · 12-person spa · South Lamar' },
  // ── CRIBS (real listings + live nightly rates) ──
  { id: 'p7', mgr: 'cribs', name: 'Eastside Lux Group Retreat', badge: 'Near downtown', price: 250, br: '5 BR · 4 BA · sleeps 16', hood: 'East Austin',
  ...
  { id: 'p8', mgr: 'cribs', name: 'Domain-Area Estate · Heated Pool + Spa', badge: 'Pool + hot tub', price: 155, br: '6 BR · 2.5 BA · sleeps 16', hood: 'North Austin',
  ...
  { id: 'p9', mgr: 'cribs', name: 'Lake Travis Estate · Spectacular Pool', badge: 'Waterfront views', price: 281, br: '7 BR · 4.5 BA · sleeps 32', hood: 'Lake Travis',
            ...
            <div id="ps-invoice" style={{ background: '#fff', color: '#111', borderRadius: 16, padding: '48px 52px', fontFamily: "'Helvetica Neue',Arial,sans-serif" }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 36 }}>
                <div>
                  ...
                  <div style={{ fontSize: 13, color: '#6b7280', marginTop: 3 }}>Proper Selects · Production Concierge</div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 32 }}>
                <div>
                  ...
                  {contactName && prodCo && <div style={{ fontSize: 13, color: '#6b7280', marginTop: 2 }}>Attn: {contactName}</div>}
                ...
                <div>
                  ...
                  <div style={{ fontSize: 13, color: '#6b7280', marginTop: 1 }}>{headcount} guests</div>
                </div>
              </div>
              {/* Line items */}
                ...
                <tbody>
                  {lines.map((l, i) => (
                    <tr key={i} style={{ borderBottom: '1px solid #f3f4f6' }}>
                      <td style={{ padding: '11px 12px', fontSize: 14, fontWeight: 600, color: '#111', maxWidth: 200 }}>{l.name}{l.party ? ` (${l.party})` : ''}</td>
